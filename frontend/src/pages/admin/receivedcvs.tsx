...
import styles from '../../styles/ReceivedCVs.module.css';
...
const ReceivedCVsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Set up polling to check for new applications every minute
    const intervalId = setInterval(fetchApplications, 60000);
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.sidebar}>
        ...
        <Link href="/admin/receivedcvs" className={`${styles.sidebarItem} ${styles.active}`}>
          <div className={styles.polygon}></div>
      ...
      <div className={styles.mainContent}>
        <h1 className={styles.pageTitle}>Received CVs</h1>
        ...
        <div className={styles.tableContainer}>
          ...
          {loading ? (
            ...
            <div className={styles.emptyMessage}>No applications received yet.</div>
          ) : (
...
export default ReceivedCVsPage;